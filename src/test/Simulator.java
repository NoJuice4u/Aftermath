...
class Simulator
{
    ...
    public final float DEVIATION   = 0.025f;
    ...
    void microTest() throws Exception
    {
        ...
        int[] sequence =
        {
                0, 0, 0, 0, 0, 1, 1, 1, 2, 1, 2, 0, 2, 2, 2, 2
        };
    ...
    void authorativeEntriesTest() throws Exception
    {
        ...
        // Fill in somewhat randomized numbers (only deviating by 1 at most for
        // neighboring nodes

        // EXPECTED RESULT:
        // Authoritative numbers show 5, and all other values are normalized to the
